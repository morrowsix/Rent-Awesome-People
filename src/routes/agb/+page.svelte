...
<div class="max-w-container-12 m-auto xl:px-0 px-7 pt-10">
  ...
  <div class="text-primary font-light text-1xl sm:text-2xl sm:leading-sm">
    <H3>§ 1 Allgemeines</H3>
    <p class="pb-5">
      (1) Die vorliegenden Geschäftsbedingungen enthalten die zwischen Ihnen und
      uns, Rent Awesome People GbmH Friedrichsstraße 28 34117 Kassel,
      ausschließlich geltenden Bedingungen. Entgegenstehende oder von unseren
      AGB abweichende Bedingungen des Auftraggebers erkennen wir nur an, wenn
      wir ausdrücklich in Textform der Geltung zustimmen. Diese AGB gelten auch
      für alle zukünftigen Geschäfte mit dem Auftraggeber, insbesondere
      Vermittlungs- , Beratungs- und Dienstverträge im Rahmen der Personalsuche
      und Personalauswahl. Wir sind Ihr Vertragspartner. Die nachfolgenden
      Allgemeinen Geschäftsbedingungen gelten für alle Leistungen zwischen uns
      und Ihnen als Unternehmer in ihrer zum Zeitpunkt des Vertragsschlusses
      gültigen Fassung. Wir nennen uns nachfolgend „Auftragnehmer“. Sie, nennen
      wir zur Erhaltung der Lesbarkeit in unseren Allgemeinen
      Geschäftsbedingungen ,,Auftraggeber“. (2) Durch den Vertragsschluss
      erkennt der Auftraggeber die nachstehenden allgemeinen
      Geschäftsbedingungen sowie die Liefer- und Zahlungsbedingungen an. Unsere
      Angebote hier finden Sie zurzeit lediglich in deutscher Sprache.
    </p>
    ...
    <p class="pb-5">
      ...
      Frage, ob ausschließlich über Wege der Onlinebörsen oder auch über weitere
      ...
      Auftraggebers eine Vorauswahl. Die im Rahmen dieser Vorauswahl nach
      ...
      der Auftragnehmer daher nicht übernehmen.
    </p>
    <H3>§ 3 Datenschutz</H3>
    <p class="pb-5">
      ...
      abgeschlossenen Verträge verwendet, etwa zur Zustellung von Dokumenten und
      ähnlichem an die von Ihnen angegebene Adresse. Eine darüber hinausgehende
      Nutzung Ihrer Bestandsdaten für Zwecke der Werbung, der Marktforschung
      ...
      Kaufverträge verwendet.
    </p>
    <H3>§ 4 Vermittlungshonorar</H3>
    <p class="pb-5">
      (1) Für unsere Tätigkeit erhalten wir ein Vermittlungshonorar in Höhe von
      3/12 des Bruttojahreszielgehalt. Der Anspruch entsteht sobald zwischen dem
      ...
      Auftraggeber. (2) Der Honoraranspruch entsteht bereits bei
      ...
      Allgemeinen Geschäftsbedingungen entspricht. (b) wenn der Bewerber bei
      ...
      Zusatzleistungen, einschließlich Sonderzahlungen und variabler Gehalts-
      oder Vergütungsanteile (z.B. 13. Monatsgehalt, Auslandszulagen, Urlaubs-
      und/oder Weihnachtsgeld, Gratifikationen, Gewinnbeteiligungen, Boni,
      ...
      den Bewerbern im Zusammenhang mit Vorstellungsgesprächen beim Auftraggeber
      entstehen, sind in dem zwischen den Parteien vereinbarten Honorar nicht
      enthalten und auf Verlangen des Bewerbers vom Auftraggeber an diesen zu
      erstatten. (7) Die gesetzliche Umsatzsteuer ist zusätzlich zu der
      vereinbarten Vergütung vom Auftraggeber an den Auftragnehmer zu zahlen.
    </p>
    <H3>§ 5 Informationspflichten/ Vorkenntnisse</H3>
    <p class="pb-5">
      (1) Der Auftraggeber verpflichtet sich, unmittelbar nach Abschluss eines
      Beschäftigungsvertrages mit einem vom Auftragnehmer vorgestellten
      Bewerber, spätestens jedoch innerhalb von 5 Werktagen, unter Nennung
      sämtlicher für die Ermittlung des Honoraranspruch notwendigen Angaben,
      ...
      zugrunde zu legen. Dem Auftraggeber bleibt im Anschluss nachgelassen, den
      ...
      mitzuteilen. Der Auftragnehmer ist für diesen Fall berechtigt im Hinblick
      auf diese Bewerber keine weiteren Tätigkeiten mehr zu entfalten. Derartige
      Bewerber unterfallen nicht dem Honoraranspruch, soweit der Auftraggeber
      seinen Informationspflichten gegenüber dem Auftragnehmer nachkommt. Sollte
      der Auftraggeber diese Information unterlassen und der Auftragnehmer auch
      im Hinblick auf diese Bewerber weitergehende Tätigkeiten entfalten, löst
      dies den Honoraranspruch aus.
    </p>
    ...
    <p class="pb-5">
      ...
      Vertragspflichten sind alle Pflichten, deren Erfüllung die ordnungsgemäße
      ...
      Arbeitsergebnisse nicht erzielt.
    </p>
    <H3>§ 8 Vertraulichkeit</H3>
    <p class="pb-5">
      (1) Die Parteien verpflichten sich wechselseitig, sämtliche während der
      Zusammenarbeit mit dem Auftraggeber bekannt gewordenen Daten und
      Informationen vertraulich zu behandeln, und nicht ohne ausdrückliche und
      ...
      Vertragsdurchführung oder erfolgt aufgrund gesetzlicher und rechtlicher
    ...
    <H3>§ 9 Kündigung</H3>
    <p class="pb-5">(1) Die Parteien können den Auftrag jederzeit mit einer Frist von
    1 Monat kündigen. (2) Das Recht zur fristlosen Kündigung für die Parteien bleibt
    davon unberührt. (2) Der Auftragnehmer kann den Auftrag insbesondere dann fristlos
    kündigen, wenn ein für ihn ein wichtiger Grund vorliegt. Ein wichtiger Grund
    in diesem Sinne liegt insbesondere vor, wenn, (a) der Auftraggeber seine vertraglichen
    Mitwirkungspflichten nicht erfüllt, (b) über das Vermögen des Auftraggebers das
    Insolvenzverfahren eröffnet wird oder (c) der Auftraggeber gegen die Vertraulichkeitsbestimmungen
    dieses Vertrages verstößt. (3) Die Kündigung entbindet den Auftraggeber nicht
    von der Zahlung der vereinbarten Vergütung, wie z.B. einer Aufwandspauschale,
    einer Abbruchfee oder des Vermittlungshonorars bei Vorliegen der Voraussetzungen
    dieser Vereinbarung. (4) Kündigungen bedürfen der Schriftform.</p>
    <H3>§ 10 Schlussbestimmungen</H3>
    <p class="pb-10">(1) Es gilt das Recht der Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts.
    Unberührt bleiben zwingende Bestimmungen des Staates, in dem Sie Ihren gewöhnlichen
    Aufenthalt haben (2) mündliche Nebenabreden zu diesem Vertrag bestehen nicht.
    Etwaige weitergehende Vertragsänderungen- oder Ergänzungen bedürfen der Schriftform.
    Dies gilt auch für Änderung der Schriftformklausel selbst. (3) Gerichtsstand
    für sämtliche Streitigkeiten aus und im Zusammenhang mit dem Vertragsverhältnis
    ist Kassel. (4) Sollten einzelne Bestimmungen dieses Vertrages unwirksam sein
    oder den gesetzlichen Regelungen widersprechen, so wird hierdurch der Vertrag
    im Übrigen nicht berührt. Die unwirksame Bestimmung wird von den Vertragsparteien
    ...
    kommt. Die vorstehende Regelung gilt entsprechend bei Regelungslücken.</p>
  </div>
</div>
