...
<div class="max-w-container-12 m-auto xl:px-0 px-7 pt-10">
  ...
  <div class="text-primary font-light text-1xl sm:text-2xl sm:leading-sm">
    ...
    <p class="pb-5">
      ...
      uns, Rent Awesome People GmbH Friedrichsstraße 28 34117 Kassel,
      ausschließlich geltenden Bedingung-gen. Entgegenstehende oder von unseren
      ...
      Geschäftsbedingungen ,,Auftraggeber“.<br /> (2) Durch den Vertragsschluss erkennt
      der Auftraggeber die nachstehenden allgemeinen Geschäftsbedingungen sowie die
      Liefer- und Zahlungsbedingungen an. Unsere Angebote hier fin-den Sie zurzeit
      lediglich in deutscher Sprache
    </p>
    ...
    <H3>§ 3 Laufzeit und Kündigung</H3>
    <p class="pb-5">
    ...
    <p class="pb-5">
      ...
      Zusatzleistungen, ein-schließlich Sonderzahlungen und variabler Gehalts-
      oder Vergütungsanteile (z.B. 13. Monats-gehalt, Auslandszulagen, Urlaubs-
    ...
    <p class="pb-5">
      ...
      Zeitaufwand wird eine Pauschale von 45,00 EUR pro Monat bestimmt. Rent
      Awesome People bleibt es unbenommen nachzuweisen, dass die konkreten
      Aufwendungen im Einzelfall höher waren. Dem Auftraggeber steht es frei,
      nachzuweisen, dass Rent Awesome People im konkreten Fall niedrigere
      Aufwendungen als die Pauschale entstanden sind. Auf jeden Fall ist der
      Ersatz der Aufwendungen auf maximal 50 % derjenigen Provision begrenzt,
      die Rent Awesome People entgangen ist.
    </p>
    <H3>§ 6 Informationspflichten/ Vorkenntnisse</H3>
    <p class="pb-5">
      ...
      Be-werber unterfallen nicht dem Honoraranspruch, soweit der Auftraggeber
    ...
    <H3>§ 7 Pflichten des Auftraggebers/ Alleinauftrag</H3>
    <p class="pb-5">
      (1) Der Auftraggeber verpflichtet sich, für die Dauer dieses Vertrags
      ...
      Vertrags zu leisten. Der Ersatz eines weiteren Schadens wird dadurch nicht
      ausgeschlossen.
    </p>
    <H3>§ 8 Datenschutz</H3>
    <p class="pb-5">
      ...
      ähnlichem an die von Ihnen angegebene Adresse. Eine darüber hin-ausgehende
    ...
    <p class="pb-10">
      ...
      Lizenzgebühren im Einzelfall unter Berücksichtigung der Rechtsprechung des
      Bundesgerichtshofes, dass bei Lizenzverstößen das Doppelte der üblichen
      Lizenz verlangt werden kann, höher waren. Dem Auftraggeber steht es frei,
      nachzuweisen, dass Rent Awesome People im konkreten Fall niedrigere
      Lizenzgebühren als die Pauschale entstanden sind.
    </p>
    ...
    <p class="pb-10">
      ...
      Vertragsparteien einvernehmlich durch eine solche Bestimmung ersetzt,
      welche dem wirtschaftlichen Sinn und Zweck der unwirksamen Bestimmung in
